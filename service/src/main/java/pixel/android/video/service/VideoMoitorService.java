...
public class VideoMoitorService {
    ...
    private static VideoPushService videoPushService;
    ...
    public static InputStream getmInputStream() {
        if (mByteArrayOutputStream == null) return null;
        return new ByteArrayInputStream(mByteArrayOutputStream.toByteArray());
    }

    public static void main(String args[]) throws IOException {

        videoPushService = new VideoPushService();
